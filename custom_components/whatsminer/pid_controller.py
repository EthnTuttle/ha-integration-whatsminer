# Vendored from ScratMan/HASmartThermostat
# https://github.com/ScratMan/HASmartThermostat/tree/master/custom_components/smart_thermostat/pid_controller
# Licensed MIT (c) 2018 The Python Packaging Authority.
# Minor changes: none — copied verbatim for local use.
import math
import logging
